...
- PMID:40954253 (Majd et al. 2025, EMBO J) — cross-dataset comparison of ENS neuron annotations
- PMID:37355216 (Chen et al. 2023, human colonic myenteric plexus chemical coding)
- PMID:34170401 (Brehmer 2021, classification of human enteric neurons)
- PMID:32888429 (Drokhlyansky et al. 2020, Cell — AR-mouse and AR-human ENS scRNA-seq) [FULL TEXT: pdfs/PMC8358727_Drokhlyansky2020_full_text.txt]
- PMID:38292899 (Chen et al. 2024, Cell Reports — first human viscerofugal neuron characterization)
...
**Literature Support**:
- PMID:37355216 (Chen et al.) — Directly defines four human colonic EMN subtypes (EMN1-4) by multilayer immunohistochemical coding: all ChAT+, NOS1-, with differential NF200 and calbindin expression. EMN1 and EMN2 are NF200+; EMN3 and EMN4 are NF200-. EMN1 and EMN3 are calbindin+; EMN2 and EMN4 are calbindin-.
- PMID:34170401 (Brehmer 2021) — Reviews EMN identification criteria across human ENS: stubby Dogiel type I morphology, ChAT+, S-type electrophysiology, smaller soma area than Dogiel type II neurons.
- PMID:40954253 (Majd et al. 2025) — Confirms EMN as a functional class recognized across multiple ENS scRNA-seq datasets. Notes that ChAT and NOS1 are the most consistently annotated markers separating EMN from IMN across datasets, though co-expression of these markers in individual neurons is more common than previously appreciated.

**Validation Notes**:
The cholinergic identity of excitatory myenteric motor neurons is among the most robustly established features in ENS biology, consistent across species and methodologies. The definition is appropriately qualified to 'primary neurotransmitter' given that co-transmitters (substance P, enkephalin) are commonly present.

## 3. Experimental Evidence

**Summary of experimental evidence**:
Chemical coding studies of human colon (Chen et al., PMID:37355216) identified 4 EMN subtypes among 2596 neurons from 12 patients using a panel of 10 antibodies. EMN subtypes collectively represent a substantial proportion of all myenteric neurons. Brehmer 2021 (PMID:34170401) summarizes comparable classifications from multiple human and animal studies. Majd et al. 2025 confirm EMN as a well-defined transcriptomic cluster across mouse and human scRNA-seq datasets (Drokhlyansky AR-mouse, AR-human).

**Literature Support**:
- PMID:37355216 — Table 7 provides full quantitative chemical coding data for EMN1-4.
- PMID:34170401 — Comprehensive review of human enteric neuron chemical coding.
- PMID:40954253 — Cross-dataset validation using scRNA-seq confirms EMN as a transcriptomically consistent class.

## 4. Cross-References

**Primary References**:
- PMID:37355216 (Chen et al. — human colonic myenteric plexus, multilayer immunohistochemical chemical coding defining EMN1-4)
- PMID:34170401 (Brehmer 2021 — classification review of human enteric neurons including EMN)

**Additional References**:
- PMID:40954253 / DOI:10.1038/s44318-025-00559-1 (Majd et al. 2025 — cross-dataset consistency of EMN annotation)
- PMID:32888429 / DOI:10.1016/j.cell.2020.08.003 (Drokhlyansky et al. 2020 — scRNA-seq ENS atlas including EMN clusters)

**Note**: Full text retrieval was successful for PMID:37355216 and PMID:34170401. Full text for PMID:40954253 was retrieved via PMC12528430_Majd2025_ENS_unified_definition.txt. Full text for PMID:32888429 (Drokhlyansky et al. 2020) was retrieved via PDF extraction (pdfs/PMC8358727_Drokhlyansky2020_full_text.txt). Full text summary for Chen et al. 2024 (PMID:38292899 — human VFN characterization) was retrieved and saved to pdfs/PMC10825022_full_text.txt.
...
**Validated Synonyms**:
- myenteric excitatory motor neuron — used in ENS classification literature
- EMN — abbreviation used in Majd et al. 2025 (PMID:40954253), Chen et al. (PMID:37355216), Drokhlyansky et al. 2020
-  non-nitrergic myenteric motor neuron — marker combination synonym; captures the defining ChAT+/NOS1− binary that is the most reliable discriminator between EMN and IMN across species (Chen et al. PMID:37355216, Brehmer 2021)
...
- `has soma location` some myenteric nerve plexus (UBERON:0002439) — Source: PMID:37355216, PMID:34170401
- `capable of` some acetylcholine secretion, neurotransmission (GO:0014055) — Source: PMID:37355216 (ChAT+), PMID:34170401
- `capable of part of` some intestine smooth muscle contraction (GO:0014827) — Source: PMID:34170401 (motor function)
...
- Cross-references: High (primary references confirm the cell type)
- Overall: High
...
**Literature Support**:
- PMID:37355216 (Chen et al.) — Defines four human colonic IMN subtypes (IMN1-4): all NOS1+, ChAT-. IMN1 and IMN2 are NF200+; IMN3 and IMN4 are NF200-. VIP is expressed in IMN1 and IMN3; NPY is expressed in IMN1 and IMN2.
- PMID:34170401 (Brehmer 2021) — Reviews human IMN: spiny Dogiel type I morphology, NOS1+, VIP+, S-type electrophysiology; the spiny Dogiel type I morphology with irregular dendrites distinguishes IMN from stubby Dogiel type I EMN.
- PMID:40954253 (Majd et al. 2025) — Confirms IMN as a well-defined functional class across ENS scRNA-seq datasets, with NOS1 as the most consistent marker; notes significant inter-dataset variability in co-transmitter assignment.
...
**Literature Support**:
- PMID:37355216 — Table 7: full quantitative chemical coding data for IMN1-4.
- PMID:34170401 — Review of IMN morphology and chemical coding in humans.
- PMID:40954253 — Cross-dataset annotation and caveats.
- PMID:32888429 / DOI:10.1016/j.cell.2020.08.003 — scRNA-seq confirmation.

## 4. Cross-References

**Primary References**:
- PMID:37355216 (Chen et al. — human colonic myenteric plexus defining IMN1-4)
- PMID:34170401 (Brehmer 2021 — human ENS classification review)

**Additional References**:
- PMID:40954253 / DOI:10.1038/s44318-025-00559-1 (Majd et al. 2025)
- PMID:32888429 / DOI:10.1016/j.cell.2020.08.003 (Drokhlyansky et al. 2020)

**Note**: Full text for PMID:32888429 (Drokhlyansky) has been retrieved (pdfs/PMC8358727_Drokhlyansky2020_full_text.txt).
...
- NOS1-positive ChAT-negative myenteric motor neuron — marker combination synonym; captures the defining NOS1+/ChAT− binary, the most reliable discriminator between IMN and EMN across species (Chen et al. PMID:37355216, Brehmer 2021)

## 7. Logical Relationships

**Validated Relationships**:
- `has soma location` some myenteric nerve plexus (UBERON:0002439) — Source: PMID:37355216, PMID:34170401
- `capable of part of` some relaxation of smooth muscle (GO:0044557) — Source: PMID:34170401 (inhibitory motor function)
- `capable of` some nitric oxide biosynthetic process (GO:0006809) — Source: PMID:37355216 (NOS1+); used as proxy for nitrergic identity
...
**Literature Support**:
- PMID:37355216 (Chen et al.) — Defines two human colonic sensory neuron subtypes (SN1 and SN2) with Dogiel type II morphology: both ChAT+, NOS1-, NF200+, substance P+, with large soma area (mean approximately 1616 µm²); SN1 is calretinin+, SN2 is calretinin-.
- PMID:34170401 (Brehmer 2021) — Comprehensive review of IPAN identification criteria: Dogiel type II morphology is the key morphological criterion; AH electrophysiology; capacity for both afferent (sensory) and interneuron functions; multiaxonal morphology enabling submucosal projections. Notes that IPANs are the only clearly multiaxonal neuron type in the myenteric plexus.
- PMID:40954253 (Majd et al. 2025) — IPAN is recognized as a functional class across ENS scRNA-seq datasets. Notes inconsistencies in TAC1 (substance P gene) assignment across datasets; some datasets assign TAC1+ expression to functional classes other than IPAN.
...
**Summary of experimental evidence**:
Chen et al. (PMID:37355216) characterized SN1 and SN2 subtypes from 2596 human colonic myenteric neurons. Both are NF200+, ChAT+, substance P+, with mean soma area approximately 2.6-fold larger than EMN classes. SN1 (calretinin+) and SN2 (calretinin-) are distinguished only by calretinin expression. Brehmer 2021 (PMID:34170401) provides additional context: Dogiel type II neurons are reliably identified by smooth oval soma, multiple processes, and AH electrophysiology, and represent a distinct population in the human myenteric plexus separate from the two morphological subtypes of Dogiel type I (stubby = ChAT+/EMN, spiny = NOS1+/IMN).

**Literature Support**:
- PMID:37355216 — Table 7: SN1 and SN2 chemical coding and soma size data.
- PMID:34170401 — Review of IPAN morphology (Dogiel type II), electrophysiology (AH), and dual sensory/interneuron function.
- PMID:40954253 — Cross-dataset recognition of IPAN/SN as a functional class with TAC1 expression caveats.

## 4. Cross-References

**Primary References**:
- PMID:37355216 (Chen et al. — human colonic myenteric plexus, SN1/SN2 corresponding to myenteric IPAN subtypes)
- PMID:34170401 (Brehmer 2021 — IPAN classification review)
...
- myenteric AH neuron — electrophysiological classification (AH = afterhyperpolarization); Source: PMID:34170401
- myenteric sensory neuron — functional synonym used in Majd et al. 2025
- multiaxonal cholinergic myenteric sensory neuron — marker combination synonym; 'multiaxonal' (Dogiel type II morphology) discriminates IPAN from all Dogiel type I neuron classes; 'cholinergic' reflects ChAT+ identity confirmed in human (Chen et al. PMID:37355216) and consistent across species

**Related Synonyms** (not exact):
- Dogiel type II neuron of myenteric plexus — morphological synonym; Source: PMID:34170401. Marked as related rather than exact because Dogiel type II morphology may not be strictly co-extensive with IPAN functional identity across all species. Note: a new morphological subterm 'Dogiel type II neuron of myenteric plexus' is proposed as a child of this term (see separate report below).

## 7. Logical Relationships

**Validated Relationships**:
- `has soma location` some myenteric nerve plexus (UBERON:0002439) — Source: PMID:37355216, PMID:34170401
- `capable of` some acetylcholine secretion, neurotransmission (GO:0014055) — Source: PMID:37355216 (ChAT+)
...
**Literature Support**:
- PMID:37355216 (Chen et al.) — Identifies three ascending interneuron (AIN1-3) and six descending interneuron (DIN1-6) subtypes in human colon. All three AIN subtypes are ChAT+, NOS1-, ENK+, NF200+. DIN subtypes are more diverse: DIN1 and DIN2 are 5-HT+; DIN3-6 include NOS1+ and other marker combinations.
- PMID:34170401 (Brehmer 2021) — Describes ascending and descending interneuron populations in human ENS; both subtypes show Dogiel type I (uniaxonal) morphology; ascending are ChAT+/ENK+; descending are chemically more diverse including 5-HT+ neurons.
- PMID:40954253 (Majd et al. 2025) — Recognizes IN as a functional class in cross-dataset comparison. Notes inconsistency in the assignment of TAC1 (substance P) and 5-HT to IN vs. other functional classes across datasets.
...
**Literature Support**:
- PMID:37355216 — Table 7: full quantitative chemical coding for AIN1-3 and DIN1-6.
- PMID:34170401 — Morphological and chemical review of myenteric interneurons.
- PMID:40954253 — Cross-dataset validation and caveats.

## 4. Cross-References

**Primary References**:
- PMID:37355216 (Chen et al. — human colonic myenteric plexus, AIN and DIN subtypes)
- PMID:34170401 (Brehmer 2021 — classification review)
...
- IN — abbreviation from Majd et al. 2025 (PMID:40954253), Chen et al.
...
- **Status**: New term (PSVN is a recognized functional class; now characterized by scRNA-seq)
...
**Literature Support**:
- **PMID:32888429 (Drokhlyansky et al. 2020)** — scRNA-seq atlas of mouse and human ENS. Key PSVN findings:
...
- PMID:40954253 (Majd et al. 2025) — Cross-dataset comparison confirming PSVN as a recognized functional class, noting marker overlap with other classes
- PMID:34170401 (Brehmer 2021) — Reviews secretomotor/vasodilator neurons primarily in submucosal plexus context
...
**Summary of experimental evidence**:
Drokhlyansky et al. 2020 (PMID:32888429) profiled 5,068 mouse enteric neurons and 1,445 human enteric neurons by snRNA-seq. In mouse:
...
**Literature Support**:
- **PMID:32888429 (Drokhlyansky et al. 2020)** — Primary scRNA-seq characterization of PSVN subtypes
- PMID:40954253 (Majd et al. 2025) — Cross-dataset validation

## 4. Cross-References

**Primary References**:
- **PMID:32888429 / DOI:10.1016/j.cell.2020.08.003 (Drokhlyansky et al. 2020)** — scRNA-seq characterization of mouse and human PSVN subtypes
- PMID:40954253 / DOI:10.1038/s44318-025-00559-1 (Majd et al. 2025)
...
**Literature Support**:
- **PMID:38292899 (Chen et al. 2024)** — First systematic characterization of human viscerofugal neurons. Key findings from 903 VFNs: (a) 89% are ChAT+ (cholinergic); (b) 0% are CART+ (N=123, explicitly tested); (c) 26% are NOS1+; (d) 10% are calbindin+. This directly contradicts the use of CART as a human VFN marker.
- PMID:40954253 (Majd et al. 2025) — States: "Cart, expressed by gene Cartpt, has been used to mark intestinofugal neurons." **CAUTION**: This statement reflects rodent literature. Chen et al. 2024 definitively shows CART is not a human marker.

**Validation Notes**:
The Chen et al. 2024 study represents a major correction to the ENS literature. CART/CARTPT, previously cited as an intestinofugal marker based on rodent studies, is NOT expressed in human VFNs. ChAT is the appropriate human marker (89%). This species difference must be reflected in any CL term definition.

## 3. Experimental Evidence

**Summary of experimental evidence**:
Chen et al. 2024 (PMID:38292899) provides the first comprehensive characterization of human viscerofugal (intestinofugal) neurons, analyzing 903 VFNs from human colon. Key quantitative findings:
...
The defining property — axonal projection from the intestinal wall to prevertebral sympathetic ganglia — was confirmed by retrograde tracing.

**Literature Support**:
- **PMID:38292899 (Chen et al. 2024)** — Primary reference for human VFN chemical coding. Definitive evidence that CART is absent in human VFNs.
- PMID:40954253 (Majd et al. 2025) — Cross-dataset comparison noting absence of VFNs from scRNA-seq datasets.

## 4. Cross-References

**Primary References**:
- **PMID:38292899 / DOI:10.1016/j.celrep.2024.113653 (Chen et al. 2024)** — First human VFN characterization: 89% ChAT+, 0% CART+. This is now the primary human reference.
- PMID:40954253 / DOI:10.1038/s44318-025-00559-1 (Majd et al. 2025 — cross-dataset comparison, VFN concept)
...
**Validated Synonyms**:
- viscerofugal neuron — preferred term in Chen et al. 2024 (PMID:38292899); abbreviated VFN
...
**Validated Relationships**:
- `has soma location` some myenteric nerve plexus (UBERON:0002439) — Source: Chen et al. 2024 (PMID:38292899)
...
- Chen et al. 2024 sampled 903 human VFNs from colon — the first comprehensive human characterization.
...
- Cross-references: **High** (PMID:38292899 is primary human reference; historical rodent references contextualized)
- Overall: **High**
...
**Literature Support**:
- PMID:37355216 (Chen et al.) — ChAT immunoreactivity confirmed for EMN (all subtypes), IPAN (SN1/SN2), and ascending interneurons (AIN1-3).
- PMID:40954253 (Majd et al. 2025) — ChAT is among the most consistently assigned markers across ENS scRNA-seq datasets for EMN, IPAN, and ascending interneuron classes.
...
**Literature Support**:
- PMID:37355216 (Chen et al.) — NOS1 confirmed for IMN (all four subtypes) and NOS1+ descending interneuron subtypes (DIN3-6 include NOS1+ populations).
- PMID:40954253 (Majd et al. 2025) — NOS1 is among the most consistently assigned markers across ENS scRNA-seq datasets.
- PMID:34170401 (Brehmer 2021) — NOS1+/VIP+ defines spiny Dogiel type I (IMN) neurons in human ENS.
...
**Literature Support**:
- PMID:37355216 (Chen et al.) — Identifies three ascending interneuron subtypes (AIN1-3) in human colonic myenteric plexus. All three are ChAT+, ENK+, NF200+, NOS1−. The uniform ChAT+/ENK+/NF200+ chemical code across AIN1-3 makes the ascending interneuron one of the most chemically consistent interneuron classes in the ENS.
- PMID:34170401 (Brehmer 2021) — Reviews ascending interneuron populations in human ENS as ChAT+/ENK+ neurons with Dogiel type I morphology; describes their role in the ascending excitatory reflex arc.
- PMID:40954253 (Majd et al. 2025) — IN class recognised across ENS datasets. Notes that TAC1/substance P assignment to IN is inconsistent across datasets; ENK (PENK gene) is among the three markers shared across all primary ENS datasets (alongside NOS1 and TAC1), supporting its use as an interneuron class marker.
...
**Summary of experimental evidence**:
Chen et al. (PMID:37355216) identified AIN1-3 from 2596 human colonic myenteric neurons. All three subtypes share ChAT+, ENK+, NF200+, NOS1− chemical coding. Subtypes differ only in quantitative expression levels, not in presence/absence of the core markers. Brehmer 2021 (PMID:34170401) provides supporting morphological context.

**Literature Support**:
- PMID:37355216 — Table 7: chemical coding for AIN1-3.
- PMID:34170401 — Review of ascending interneuron morphology and function.
- PMID:40954253 — Cross-dataset PENK expression confirming ENK as a shared ENS marker.

## 4. Cross-References

**Primary References**:
- PMID:37355216 (Chen et al. — human colonic myenteric plexus AIN1-3)
- PMID:34170401 (Brehmer 2021 — review)

**Additional References**:
- PMID:40954253 / DOI:10.1038/s44318-025-00559-1 (Majd et al. 2025 — cross-dataset marker validation)
...
- AIN — abbreviation used in Chen et al. (PMID:37355216)
...
**Literature Support**:
- PMID:37355216 (Chen et al.) — Identifies six descending interneuron subtypes (DIN1-6) in human colonic myenteric plexus. DIN1 and DIN2 are 5-HT+; DIN3-6 include NOS1+ and other marker combinations. Chemical diversity is substantially greater than that of ascending interneurons.
- PMID:34170401 (Brehmer 2021) — Reviews descending interneuron populations including 5-HT+ neurons and other chemically diverse subtypes; describes their role in the descending inhibitory reflex arc with Dogiel type I morphology.
- PMID:40954253 (Majd et al. 2025) — Notes that 5-HT assignment is among the most inconsistent across ENS scRNA-seq datasets, cautioning against sole reliance on 5-HT as a descending interneuron marker.
...
**Summary of experimental evidence**:
Chen et al. (PMID:37355216) identified DIN1-6 from 2596 human colonic myenteric neurons. The six subtypes show more diverse chemical coding than the three AIN subtypes. DIN1 and DIN2 are 5-HT+; DIN3-6 are distinguished by varying combinations of NOS1, VIP, and other markers. Brehmer 2021 provides additional morphological and functional context.

**Literature Support**:
- PMID:37355216 — Table 7: chemical coding for DIN1-6.
- PMID:34170401 — Morphological and functional review of descending interneurons.
- PMID:40954253 — 5-HT assignment inconsistency across datasets; caution for scRNA-seq-based annotation.

## 4. Cross-References

**Primary References**:
- PMID:37355216 (Chen et al. — human colonic myenteric plexus DIN1-6)
- PMID:34170401 (Brehmer 2021 — review)

**Additional References**:
- PMID:40954253 / DOI:10.1038/s44318-025-00559-1 (Majd et al. 2025 — 5-HT inconsistency caveat)
...
- DIN — abbreviation used in Chen et al. (PMID:37355216)
...
## 9. Additional Notes
- The 5-HT+ descending interneuron subtype is the most frequently cited but also the most dataset-inconsistent (Majd et al. 2025).
...
**Literature Support**:
- PMID:34170401 (Brehmer 2021) — Explicitly distinguishes stubby Dogiel type I morphology (flat/lamellar dendrites, medium soma, uniaxonal, ChAT+) from spiny Dogiel type I morphology (irregular spine-like dendrites, NOS1+) as the morphological correlate of excitatory and inhibitory motor function respectively. Primary reference for the stubby/spiny distinction in human ENS.
- PMID:37355216 (Chen et al.) — EMN subtypes EMN1-4 are all Dogiel type I; EMN1 and EMN2 are NF200+, EMN3 and EMN4 are NF200−; all are ChAT+/NOS1−, consistent with stubby Dogiel type I assignment per Brehmer 2021.
...
**Summary of experimental evidence**:
Brehmer 2021 (PMID:34170401) provides the primary morphological characterisation of the stubby Dogiel type I variant in human ENS, distinguishing it from the spiny Dogiel type I morphology of IMN and the multiaxonal morphology of Dogiel type II (IPAN). Chen et al. (PMID:37355216) confirm ChAT+/NOS1− identity for all EMN subtypes in a quantitative immunohistochemical study of human colonic myenteric plexus.

**Literature Support**:
- PMID:34170401 — Morphological classification of stubby vs. spiny Dogiel type I in human ENS.
- PMID:37355216 — Chemical coding of EMN subtypes (ChAT+, NOS1−) in human colon.

## 4. Cross-References

**Primary References**:
- PMID:34170401 (Brehmer 2021 — morphological classification)
- PMID:37355216 (Chen et al. — chemical coding of EMN)
...
**Summary of experimental evidence**:
Brehmer 2021 (PMID:34170401) provides the primary morphological characterisation of the spiny Dogiel type I variant in human ENS. Chen et al. (PMID:37355216) confirm NOS1+/ChAT− identity for all IMN subtypes in a quantitative immunohistochemical study of 2596 human colonic myenteric neurons.

**Literature Support**:
- PMID:34170401 — Morphological classification of spiny Dogiel type I in human ENS.
- PMID:37355216 — Chemical coding of IMN subtypes (NOS1+, ChAT−) in human colon.

## 4. Cross-References

**Primary References**:
- PMID:34170401 (Brehmer 2021 — morphological classification)
- PMID:37355216 (Chen et al. — chemical coding of IMN)
...
**Literature Support**:
- PMID:34170401 (Brehmer 2021) — Detailed description of Dogiel type II morphology in human ENS: smooth oval soma, multiaxonal (multiple long processes without proximal branching), large soma, AH electrophysiology, distinct from both Dogiel type I variants. Confirms these neurons project to submucosal plexus and mucosa as well as within the myenteric plexus.
- PMID:37355216 (Chen et al.) — SN1 and SN2 subtypes: both ChAT+, NOS1−, NF200+, substance P+, large soma (mean ~1616 µm², approximately 2.6-fold larger than EMN classes); SN1 calretinin+, SN2 calretinin−. These data are consistent with Dogiel type II assignment.
- PMID:40954253 (Majd et al. 2025) — Confirms IPAN/sensory neuron class across ENS datasets; notes inconsistency in TAC1/substance P assignment across scRNA-seq datasets, suggesting this is not a reliable solo marker.
...
**Summary of experimental evidence**:
Brehmer 2021 (PMID:34170401) provides comprehensive morphological characterisation of Dogiel type II neurons in human ENS as the third major morphological class alongside stubby and spiny Dogiel type I. Chen et al. (PMID:37355216) characterised SN1 and SN2 subtypes by multilayer immunohistochemistry in 2596 human colonic myenteric neurons; both subtypes are ChAT+/NOS1−/NF200+ with large soma area consistent with Dogiel type II assignment.

**Literature Support**:
- PMID:34170401 — Morphological classification and multiaxonal connectivity of Dogiel type II neurons.
- PMID:37355216 — Chemical coding (ChAT+, NOS1−, NF200+, SP+) and soma size data for SN1/SN2.
- PMID:40954253 — Cross-dataset IPAN recognition and TAC1 expression caveats.

## 4. Cross-References

**Primary References**:
- PMID:34170401 (Brehmer 2021 — morphological classification)
- PMID:37355216 (Chen et al. — chemical coding of SN1/SN2)
...
**Literature Support**:
- PMID:34170401 (Brehmer 2021) — Comprehensive review of Dogiel morphological classification in human ENS: Dogiel type II neurons are distinguished by smooth oval soma, multiple long processes, large soma size, and multiaxonal connectivity pattern. Contrast with stubby Dogiel type I (excitatory motor neurons) and spiny Dogiel type I (inhibitory motor neurons).
...
- Human ENS (Brehmer 2021; Chen et al. 2023)
- Mouse ENS (multiple studies)

Key morphological features validated by Brehmer 2021 (PMID:34170401):
...
**Primary References**:
- PMID:34170401 (Brehmer 2021 — morphological classification review)
...
**Literature Support**:
- PMID:37355216 (Chen et al.) — Defines SN1 as calretinin+, ChAT+, NOS1−, substance P+ with large soma area (mean ~1616 µm²) in a survey of 2596 human colonic myenteric neurons. SN1 is the calretinin-expressing IPAN subtype; the sole chemical distinction from SN2 is calretinin immunoreactivity.
- PMID:34170401 (Brehmer 2021) — Notes calretinin expression in Dogiel type II neurons in human ENS as part of a broader review of chemical coding.
- PMID:40954253 (Majd et al. 2025) — Calretinin (CALR gene) is noted as a marker for the sensory neuron cluster in cross-dataset ENS scRNA-seq comparison.
...
**Summary of experimental evidence**:
Chen et al. (PMID:37355216) identified SN1 from 2596 human colonic myenteric neurons by multilayer IHC. All SN1 neurons are calretinin+, ChAT+, NOS1−, substance P+, with large soma area consistent with Dogiel type II morphology. Calretinin immunoreactivity provides a clean positive categorical marker distinguishing SN1 from SN2.

**Literature Support**:
- PMID:37355216 — Table 7: SN1 (CalR+) chemical coding and soma size data.
- PMID:34170401 — Calretinin expression in Dogiel type II neurons in human ENS.
- PMID:40954253 — CALR as a cross-dataset IPAN marker.

## 4. Cross-References

**Primary References**:
- PMID:37355216 (Chen et al. — SN1 subtype definition in human colonic myenteric plexus)
- PMID:34170401 (Brehmer 2021 — calretinin in human ENS IPAN context)

**Additional References**:
- PMID:40954253 / DOI:10.1038/s44318-025-00559-1 (Majd et al. 2025 — CALR cross-dataset marker)
...
**Validated Synonyms**:
- SN1 — abbreviation used in Chen et al. (PMID:37355216) chemical coding scheme
...
**Literature Support**:
- PMID:37355216 (Chen et al.) — Defines SN2 as calretinin−, ChAT+, NOS1−, substance P+, with large soma area (mean ~1616 µm²). SN2 is distinguished from SN1 solely by the absence of calretinin immunoreactivity; all other chemical and morphological properties are shared.
- PMID:34170401 (Brehmer 2021) — Notes that not all Dogiel type II neurons are calretinin-positive in human ENS; calretinin-negative Dogiel type II neurons have been identified.
- PMID:40954253 (Majd et al. 2025) — IPAN/sensory neuron class recognised across datasets; calretinin marks a subset of this class.
...
**Summary of experimental evidence**:
Chen et al. (PMID:37355216) characterised SN2 from 2596 human colonic myenteric neurons. SN2 is ChAT+, NOS1−, substance P+, calretinin−, with large soma area consistent with Dogiel type II morphology. The calretinin-negative status is established in the context of the positive identification of SN1 as calretinin+, making SN2 the complementary IPAN population.

**Literature Support**:
- PMID:37355216 — Table 7: SN2 (CalR−) chemical coding and soma size data.
- PMID:34170401 — Calretinin-negative Dogiel type II neurons in human ENS.
- PMID:40954253 — IPAN class recognition across datasets.

## 4. Cross-References

**Primary References**:
- PMID:37355216 (Chen et al. — SN2 subtype definition in human colonic myenteric plexus)
- PMID:34170401 (Brehmer 2021 — calretinin-negative context in human ENS)
...
**Validated Synonyms**:
- SN2 — abbreviation used in Chen et al. (PMID:37355216)
...
|------|-----|-------|--------------|---------|--------------------------|
| 40954253 | 10.1038/s44318-025-00559-1 | A call for a unified and multimodal definition of cellular identity in the enteric nervous system (Majd et al. 2025) | pdfs/PMC12528430_Majd2025_ENS_unified_definition.txt | not retrieved | not retrieved |
| 37355216 | 10.1016/j.jcmgh.2023.06.010 | Types of Neurons in the Human Colonic Myenteric Plexus Identified by Multilayer Immunohistochemical Coding (Chen et al. 2023) | pdfs/PMC10469081_full_text.txt | not retrieved | not retrieved |
| 34170401 | 10.1007/s00418-021-02002-y | Classification of human enteric neurons (Brehmer 2021) | pdfs/PMC8397665_full_text.txt | not retrieved | not retrieved |
...
| 38292899 | 10.3389/fnins.2023.1313057 | Characterization of viscerofugal neurons in human colon (Chen et al. 2024) | pdfs/PMC10825022_full_text.txt (summary) | not retrieved | not retrieved |
...
**5. Secretomotor/vasodilator neuron of myenteric plexus (PSVN)**
Now characterized by Drokhlyansky et al. 2020 (PMID:32888429). Mouse: two Glp2r+ subtypes — PSVN1 (VIP+ non-cholinergic, Fst+) and PSVN2 (ChAT+, Gal+, Npy+). Human: only VIP+ subtype detected. Conserved program: VIP, Gal, Scgn, Calb2. Marker combination synonym: 'VIP-positive secretomotor neuron'. Medium-High confidence (species difference in cholinergic subtype).

**6. Intestinofugal neuron (viscerofugal neuron, VFN)**
Definitive human characterization by Chen et al. 2024 (PMID:38292899): 89% ChAT+, 0% CART+ (N=123). CART is NOT a human marker (rodent-specific). Marker combination synonym: 'cholinergic viscerofugal neuron'. High confidence.
...
**Note on Term 5 (PSVN)**: Drokhlyansky et al. 2020 (PMID:32888429) provides scRNA-seq characterization of two mouse PSVN subtypes (VIP+ non-cholinergic and ChAT+ cholinergic). In human, only the VIP+ subtype was detected. Term is now Ready for integration with species-specific notes.

**Note on Term 11 (Intestinofugal/VFN)**: Chen et al. 2024 (PMID:38292899) provides definitive human characterization with critical correction: CART is NOT a human marker (0%), ChAT is the primary marker (89%). Ready for integration.
...
1. ~~Retrieve full text: Drokhlyansky et al. 2020~~ **DONE** — pdfs/PMC8358727_Drokhlyansky2020_full_text.txt
2. Confirm reason for obsoletion of CL:0008014 before creating 'excitatory motor neuron of myenteric plexus'
3. ~~Create general 'Dogiel type II neuron' CL term~~ **INCLUDED** — see new section below; sibling to CL:4047038
4. Find PATO terms for: lamellar dendrite morphology (stubby Dogiel I), spine-like dendrite morphology (spiny Dogiel I), multiaxonal morphology (Dogiel type II)
5. Find PRO ID for calretinin (CALB2 gene product) for `expresses` relation on calretinin-positive IPAN subterm
6. Find UBERON terms for prevertebral sympathetic ganglia (celiac: UBERON:0002262, superior mesenteric: UBERON:0005479, inferior mesenteric: UBERON:0005480) — **CONFIRMED**
7. Flag GO editors: request `nitric oxide secretion, neurotransmission` GO term analogous to GO:0014055; update nitrergic grouping class EquivalentClass axiom when created
8. Confirm CL:4047038 scope — is it already restricted to enteric neurons?
9. Confirm CL:0000108 scope before asserting dual parentage on cholinergic grouping class
10. Check whether a general 'nitrergic neuron' CL term exists; if so, add as parent of nitrergic grouping class
11. Confirm cross-species validity of stubby/spiny Dogiel type I distinction in mouse and rat
12. Confirm cross-species validity of calretinin+/− IPAN split (SN1/SN2) in mouse

**CURATION UPDATE 2026-03-10**:
- Drokhlyansky et al. 2020 full text retrieved (PDF extracted)
- Chen et al. 2024 (PMID:38292899) retrieved — first human VFN characterization
